...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1799)), "F:\\Front-end Development\\ReactAppPersonalPage\\joakimhallbomportfolio\\src\\app\\page.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4232)), "F:\\Front-end Development\\ReactAppPersonalPage\\joakimhallbomportfolio\\src\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2819))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["F:\\Front-end Development\\ReactAppPersonalPage\\joakimhallbomportfolio\\src\\app\\page.tsx"];
...
var __webpack_exports__ = __webpack_require__.X(0, [381,58], () => (__webpack_exec__(197)));
